...
class MessageCreate(BaseModel):
    content: str
    proprietaire_id: Optional[uuid.UUID] = None  # Requis si gestionnaire envoie le message
            ...
            for pid in ids:
                ...
                if last:
                    ...
                    conversations.append({
                        ...
                        "proprietaire_name": last.proprietaire.full_name if last.proprietaire else "?",
...
async def send_message(
    ...
    if role == Role.PROPRIETAIRE:
        ...
        if not data.proprietaire_id:
            raise HTTPException(status_code=400, detail="proprietaire_id requis pour le gestionnaire")
