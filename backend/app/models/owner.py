...
class Owner(Base, TimestampMixin):
    ...
    national_id: Mapped[str | None] = mapped_column(String(50), nullable=True)  # SIRET / n° pièce
    ...
    documents: Mapped[list["Document"]] = relationship(
        "Document",
        primaryjoin="and_(Document.entity_type=='owner', foreign(Document.entity_id)==Owner.id)",
        viewonly=True,
        lazy="select",
    )
