...
DEFAULTS: dict[str, dict[str, dict[str, str]]] = {
    "avis_echeance": {
        "fr": {
            "subject": "Avis d'échéance : {{period}}",
        ...
        "pt-BR": {
            "subject": "Aviso de vencimento: {{period}}",
    ...
    "quittance": {
        ...
        "pt-BR": {
            "subject": "Recibo de aluguel: {{period}}",
    ...
    "rappel_impaye": {
        "fr": {
            "subject": "Rappel : loyer {{period}} impayé",
        ...
        "en": {
            "subject": "Reminder: rent {{period}} unpaid",
        ...
        "pt-BR": {
            "subject": "Lembrete: aluguel {{period}} em aberto",
        ...
        "ht": {
            "subject": "Rapèl : lwaye {{period}} pa peye",
        ...
        "srn": {
            "subject": "Memre: oyti {{period}} no pai",
    ...
    "relance_1": {
        "fr": {
            "subject": "Relance : loyer {{period}} impayé",
        ...
        "en": {
            "subject": "Follow-up: rent {{period}} unpaid",
        ...
        "pt-BR": {
            "subject": "Cobrança: aluguel {{period}} em aberto",
        ...
        "ht": {
            "subject": "Relans : lwaye {{period}} pa peye",
        ...
        "srn": {
            "subject": "Memre-brifi: oyti {{period}} no pai",
    ...
    "relance_2": {
        "fr": {
            "subject": "Mise en demeure : loyer {{period}} impayé",
        ...
        "en": {
            "subject": "Formal notice: rent {{period}} unpaid",
        ...
        "pt-BR": {
            "subject": "Notificação formal: aluguel {{period}} em aberto",
        ...
        "ht": {
            "subject": "Mizan demè : lwaye {{period}} pa peye",
        ...
        "srn": {
            "subject": "Ofisi-warskow: oyti {{period}} no pai",
    ...
    "revision_loyer": {
        "fr": {
            "subject": "Révision de votre loyer au {{effective_date}}",
        ...
        "en": {
            "subject": "Rent review effective {{effective_date}}",
        ...
        "pt-BR": {
            "subject": "Reajuste do aluguel a partir de {{effective_date}}",
        ...
        "ht": {
            "subject": "Revizyon lwaye ou nan {{effective_date}}",
        ...
        "srn": {
            "subject": "Kenki fu yu oyti fu {{effective_date}}",
    ...
    "revision_charges": {
        "fr": {
            "subject": "Révision de vos charges au {{effective_date}}",
        ...
        "en": {
            "subject": "Charges review effective {{effective_date}}",
        ...
        "pt-BR": {
            "subject": "Reajuste dos encargos a partir de {{effective_date}}",
        ...
        "ht": {
            "subject": "Revizyon chaj ou nan {{effective_date}}",
        ...
        "srn": {
            "subject": "Kenki fu yu kostu fu {{effective_date}}",
    ...
    "taxe_om": {
        "fr": {
            "subject": "Taxe d'ordures ménagères {{year}}",
        ...
        "en": {
            "subject": "Household waste tax {{year}}",
...
async def backfill_default_message_templates(db) -> int:
    ...
    managers = (
        (
            await db.execute(
                select(User.id).where(User.role.in_(("gestionnaire", "gestionnaire_proprio")))
            )
        )
        .scalars()
        .all()
    ...
    existing = set(
        (row[0], row[1])
        for row in (
            await db.execute(select(MessageTemplate.gestionnaire_id, MessageTemplate.rule_type))
        ).all()
    )
    for mid in managers:
