...
def upgrade() -> None:
    ...
    lease_type_enum.create(op.get_bind(), checkfirst=True)
    payment_method_enum.create(op.get_bind(), checkfirst=True)
    inspection_type_enum.create(op.get_bind(), checkfirst=True)
    overall_condition_enum.create(op.get_bind(), checkfirst=True)
    ...
    op.create_table(
        ...
        sa.Column(
            "lease_type",
            sa.Enum("vide", "meuble", "mobilite", "commercial", name="lease_type_enum"),
            nullable=False,
            server_default="vide",
        ),
        ...
        sa.Column(
            "payment_method",
            sa.Enum("virement", "cheque", "prelevement", "especes", name="payment_method_enum"),
            nullable=False,
    ...
    op.create_table(
        ...
        sa.Column(
            "overall_condition",
            sa.Enum("tres_bon", "bon", "moyen", "mauvais", name="overall_condition_enum"),
            nullable=True,
        ),
