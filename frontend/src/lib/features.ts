...
export const FEATURE_LABELS: Record<string, string> = {
  ...
  diffusion: 'Diffusion des annonces',
  incidents: 'Démarche',
  entretiens: 'Entretiens',
  contacts: "Carnet d'adresses",
  offres: 'Offres & Services',
  documents_caf: 'Documents CAF',
...
export const FEATURE_DESCRIPTIONS: Record<string, string> = {
  ...
  diffusion: "Diffusez vos biens : contenu et photos pré-enregistrés par bien, plateformes de partage, publication immédiate ou programmée sur une page d'annonce partageable.",
  ...
  documents_caf: "Génération des documents CAF : attestation de loyer et formulaire tiers payant.",
