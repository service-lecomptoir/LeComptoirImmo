...
export const PATH_FEATURES: [string, string][] = [
  ...
  ['/contacts', 'contacts'],
  ['/boutique-residence', 'boutique_residence'],
  ['/documents-caf', 'documents_caf'],
  ['/etats-des-lieux', 'etats_des_lieux'],
  ['/admin', 'admin'],
...
export const FEATURE_LABELS: Record<string, string> = {
  ...
  boutique_residence: 'Commerces partenaires',
  documents_caf: 'Espace CAF',
  etats_des_lieux: 'État des lieux',
...
export const FEATURE_DESCRIPTIONS: Record<string, string> = {
  ...
  boutique_residence: "Rattachez des gérants Le Comptoir Market (le vôtre ou d'autres, autant que vous voulez) : leurs boutiques sont listées ici et vos locataires y ont accès. Un gérant rattaché qui n'a pas encore de compte le reçoit par e-mail.",
  ...
  etats_des_lieux: "Réalisez les états des lieux du logement en deux temps : à l'arrivée (état des lieux d'entrée du locataire, par bail) et au départ (processus de sortie complet : préavis, état des lieux de sortie comparé à l'entrée, décompte du dépôt de garantie et clôture du dossier).",
