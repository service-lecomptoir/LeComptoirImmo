        ...
        <tbody className="divide-y divide-gray-100">
          {items.length === 0 ? (
            ...
            <tr key={i} className="hover:bg-gray-50">
              ...
              {showOwner && <td className="px-4 py-3 text-sm text-gray-600 text-center">{e.proprietaire || '·'}</td>}
              <td className="px-4 py-3 text-sm text-gray-600 text-center">{e.locataire || '·'}</td>
              <td className="px-4 py-3 text-sm text-gray-800 text-center">{e.intitule}</td>
