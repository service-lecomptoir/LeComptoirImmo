...
const GUIDE_MANDATAIRE: Guide = {
  ...
  steps: [
    ...
    { title: '7. Publiez vos annonces', desc: "Onglet « Publication des annonces » : définissez une fois vos plateformes de partage, puis composez l'annonce de chaque bien (photos issues de ses documents, description, loyer) et publiez-la immédiatement ou programmez sa publication. Suivez ensuite ses performances (vues) depuis la même page." },
  ...
  tips: [
    ...
    "Préparez vos annonces à l'avance : le contenu et les photos sont enregistrés par bien et réutilisables, la publication peut être programmée et les vues sont suivies automatiquement.",
  ...
  faq: [
    { q: 'Comment publier l\'annonce d\'un bien ?', a: 'Onglet « Publication des annonces », ou bouton « Diffuser » sur la fiche du bien : sélectionnez les photos (issues des documents du bien) et vos plateformes, rédigez le texte, puis publiez tout de suite ou programmez la date. Une page d\'annonce publique partageable est générée et ses vues sont comptabilisées. Cette rubrique peut être incluse ou non selon votre formule.' },
...
const GUIDE_GP: Guide = {
  ...
  steps: [
    ...
    { title: '7. Publiez vos annonces', desc: "Onglet « Publication des annonces » : définissez vos plateformes de partage, composez l'annonce de chaque bien (photos issues de ses documents, description, loyer), publiez ou programmez, puis suivez les performances (vues)." },
  ...
  faq: [
    ...
    { q: 'Comment publier l\'annonce d\'un bien ?', a: 'Onglet « Publication des annonces », ou bouton « Diffuser » sur la fiche du bien : choisissez les photos et vos plateformes, rédigez le texte, puis publiez ou programmez la publication. La page d\'annonce publique est partageable et ses vues sont suivies. Cette rubrique peut être incluse ou non selon votre formule.' },
