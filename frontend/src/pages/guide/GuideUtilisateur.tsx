...
const GUIDE_MANDATAIRE: Guide = {
  ...
  steps: [
    ...
    { title: "6. Éditez l'Espace CAF", desc: "Onglet « Espace CAF » : générez l'attestation de loyer et le formulaire tiers payant pré-remplis pour chaque contrat (le bailleur n'a plus qu'à vérifier et signer). Un rappel s'affiche de juillet à décembre pour la déclaration de loyer annuelle à la CAF." },
  ...
  faq: [
    ...
    { q: 'Comment générer une attestation de loyer ou un formulaire tiers payant pour la CAF ?', a: 'Onglet « Espace CAF » : sélectionnez le contrat et téléchargez l\'attestation de loyer ou le formulaire tiers payant, pré-remplis à partir du bailleur, du locataire et du bail. Un rappel de déclaration de loyer s\'affiche de juillet à décembre. Cette rubrique peut être incluse ou non selon votre formule.' },
...
const GUIDE_GP: Guide = {
  ...
  steps: [
    ...
    { title: "6. Éditez votre Espace CAF", desc: "Onglet « Espace CAF » : attestation de loyer et formulaire tiers payant pré-remplis, prêts à signer ; rappel de déclaration de loyer affiché de juillet à décembre." },
