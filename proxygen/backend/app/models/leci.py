...
ProxyGen les utilise en lecture/écriture (blocage cascade) sans modifier le schéma LeCI.
Ces modèles utilisent une Base séparée pour éviter les conflits avec la Base de ProxyGen.
"""
import uuid
