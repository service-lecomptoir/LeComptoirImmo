...
class ProxygenSubscriptionRequest(Base):
    """Demande de souscription / démo envoyée depuis la page d'accueil
    Le Comptoir Immo, à traiter par l'équipe ProxyGen."""
    __tablename__ = "proxygen_subscription_requests"
    ...
    def __repr__(self) -> str:
        return f"<ProxygenSubscriptionRequest {self.email} [{self.status}]>"
