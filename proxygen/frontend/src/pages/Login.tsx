      ...
      >
        ...
        <div className="relative z-10 px-12 pt-12">
          <div className="flex items-center gap-3">
            ...
            <span className="text-white font-bold text-lg tracking-wide">ProxyGen</span>
          </div>
        </div>
        ...
        <div className="relative z-10 px-12 pb-10">
          <p className="text-indigo-400 text-xs">
            &copy; {new Date().getFullYear()} ProxyGen &middot; Espace super-administrateur
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center bg-white px-6 py-12 lg:px-16">
        ...
        <div className="lg:hidden mb-10 text-center">
          <div className="inline-flex items-center gap-2.5">
            ...
            <span className="font-bold text-lg text-indigo-900">ProxyGen</span>
          </div>
        </div>
        ...
        <div className="w-full max-w-[400px]">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  autoComplete="email"
                  placeholder="superadmin@proxygen.fr"
          ...
          <div className="mt-7 pt-5 border-t border-gray-100 flex items-center justify-center gap-1.5">
            ...
            <span className="text-xs text-gray-400">Acces restreint aux super-administrateurs</span>
          </div>
        </div>
      </div>
    </div>
