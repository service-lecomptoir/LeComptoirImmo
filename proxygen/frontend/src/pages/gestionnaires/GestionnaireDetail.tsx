    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 p-6">
        <div className="flex items-center gap-4 mb-5">
          ...
          <div>
            <h3 className="font-semibold text-gray-900">
              {action === 'block' ? 'Bloquer ce gestionnaire ?' : 'Debloquer ce gestionnaire ?'}
            </h3>
        ...
        <p className="text-sm text-gray-600 mb-6">
          {action === 'block'
            ? 'Le gestionnaire et tous ses proprietaires et locataires seront desactives. Vous pourrez les reactivez en debloquant le gestionnaire.'
            : 'Le gestionnaire et tous les utilisateurs bloques en cascade seront reac...'}
        </p>
        ...
        <div className="flex justify-end gap-3">
          ...
          >
            {action === 'block' ? 'Bloquer' : 'Debloquer'}
          </button>
        </div>
      </div>
    </div>
...
export default function GestionnaireDetail() {
  ...
  const handleBlockAction = async () => {
    ...
    try {
      ...
      setGestionnaire(data)
      setSuccess(confirmAction === 'block' ? 'Gestionnaire bloque' : 'Gestionnaire debloque')
      setTimeout(() => setSuccess(null), 3000)
    } catch (err: unknown) {
      const axiosError = err as { response?: { data?: { detail?: string } } }
    ...
    <div className="p-8 max-w-5xl mx-auto">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        >
          ...
          {actionLoading ? 'En cours...' : isBlocked ? 'Debloquer' : 'Bloquer'}
        </button>
      </div>
      ...
      {isBlocked && (
        <div className="mb-6 flex items-center gap-3 px-4 py-3 bg-red-50 border border-red-200 rounded-xl">
          ...
          <p className="text-sm text-red-700 font-medium">
            Ce gestionnaire est bloque. Ses proprietaires et locataires sont desactives en cascade.
          </p>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-5">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
            <h3 className="text-sm font-semibold text-gray-700 mb-4">Resume</h3>
            <div className="space-y-3 text-sm">
              ...
              <div className="flex justify-between">
                <span className="text-gray-500">Biens crees</span>
